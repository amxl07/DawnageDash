-- Reset and populate workout_logs for user 950030ed-fef7-46dc-9547-dcd994be27c4
-- 6 Weeks of history (Dec 1, 2025 - Jan 10, 2026)
-- Schedule: Mon (Push), Wed (Pull), Fri (Legs)

-- 1. clear existing logs
DELETE FROM workout_logs WHERE user_id = '950030ed-fef7-46dc-9547-dcd994be27c4';

-- WEEK 1 (Dec 1 - Dec 7)
-- Day 1: Push
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-01', 'Push Day A',
    '[
...
-- Day 2: Pull
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-03', 'Pull Day A',
    '[
...
-- Day 3: Legs
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-05', 'Leg Day A',
    '[
...
-- Day 1: Push
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-08', 'Push Day A',
    '[
...
-- Day 2: Pull
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-10', 'Pull Day A',
    '[
...
-- Day 3: Legs
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-12', 'Leg Day A',
    '[
...
-- Day 1: Push
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-15', 'Push Day A',
    '[
...
-- Day 2: Pull
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-17', 'Pull Day A',
    '[
...
-- Day 3: Legs
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-19', 'Leg Day A',
    '[
...
-- Day 1: Push
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-22', 'Push Day (Deload)',
    '[
...
-- Day 2: Pull
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-24', 'Pull Day (Deload)',
    '[
...
-- Day 3: Legs
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-26', 'Leg Day (Deload)',
    '[
...
-- Day 1: Push
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-29', 'Push Day A',
    '[
...
-- Day 2: Pull
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2025-12-31', 'Pull Day A',
    '[
...
-- Day 3: Legs
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2026-01-02', 'Leg Day A',
    '[
...
-- Day 1: Push
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2026-01-05', 'Push Day A',
    '[
...
-- Day 2: Pull
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2026-01-07', 'Pull Day A',
    '[
...
INSERT INTO workout_logs (user_id, date, title, content) VALUES (
    '950030ed-fef7-46dc-9547-dcd994be27c4', '2026-01-09', 'Leg Day A',
    '[
