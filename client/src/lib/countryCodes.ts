...
export const allCountryCodes = [
    ...
    { code: "+1-869", country: "St Kitts & Nevis", flag: "🇰🇳" },
    { code: "+1-758", country: "St Lucia", flag: "🇱🇨" },
    { code: "+1-784", country: "St Vincent", flag: "🇻🇨" },
    ...
    { code: "+1-649", country: "Turks & Caicos", flag: "🇹🇨" },
    ...
    { code: "+1-284", country: "Virgin Islands (UK)", flag: "🇻🇬" },
